                ...
                <table name="categories" class="t_form">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <select id="sellers" name="sellers" v-on:change="changeSellerFn" v-model="productData.sellerSysId">
                        ...
                        <tr>
                            ...
                            <th>진열설정</th>
                            <td>
                                <input type="radio" id="isDisplay_F" name="isDisplay" value="0" v-model.number="productData.isDisplay"><label for="isDisplay_F">미진열</label>&nbsp;
                                <input type="radio" id="isDisplay_T" name="isDisplay" value="1" v-model.number="productData.isDisplay" class="mgl20"><label for="isDisplay_T">진열</label>
                            </td>
                        </tr>
