  ...
  <div id="contents">
    ...
    <b-form enctype="multipart/form-data" @submit.prevent="onSubmit">
        ...
        <table name="categories" class="t_form">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3">
                <template v-if="imageEvent.isDisplay">
                  <b-progress :animated="true" height="2px" :value="imageEvent.progress"  style="margin-top: -5px; margin-left: -10px; margin-right: -10px; margin-bottom: 10px"></b-progress>
                </template>
            ...
            <template v-if="!productData.isAutoImageUpload">
              <tr class="imgManuals">
                ...
                <td colspan="3">
                  <input type="file" name="middleImageUrl" id="middleImageUrl"/>
                  <br />
              ...
              <tr class="imgManuals">
                ...
                <td colspan="3">
                  <input type="file" name="smallImageUrl" id="smallImageUrl"/>
                  <br />
            ...
            <tr>
              ...
              <td colspan="3" class="img_etc">
                <Image-uploader :productData="productData" :images="images" @imageUploader="onNewSingleImageUploadEvent"></Image-uploader>
              </td>
            </tr>
            <!-- 상품 이미지 : 끝 -->
            <!-- 영상 업로더 : 시작 -->
            <tr>
              ...
              <td colspan="3" class="img_etc">
                <Video-uploader ref="videoRef" :productData="productData" :videos="videos" @imageUploader="onNewSingleImageUploadEvent" />
              </td>
            </tr>
            <!-- 영상 업로더 : 끝 -->
            ...
            <tr>
              ...
              <td>
                <!-- 무제한 -->
                <span>
                  <input type="radio" id="stockTypeCode1" name="stockTypeCode" value="1" v-model.number="productData.stockTypeCode"/>
                  <label for="stockTypeCode1">무제한</label>
                </span>

                <!-- 수량설정 -->
                <span class="mgl20">
                  <input type="radio" id="stockTypeCode2" name="stockTypeCode" value="2" v-model.number="productData.stockTypeCode"/>
                  <label for="stockTypeCode2">수량</label>
                </span>
                <span>
                  <input type="text" name="stockQty" maxlength="7" class="text_input number_input" style="width: 60px;" v-model.number="productData.stockQty" :disabled="productData.stockTypeCode === 1"/>
                </span>
                ...
                <div class="d-flex" style="width:100%">
                  <template v-if="productData.feeTypeCode === 1">
                    <div style="width: 200px">
                      <input type="checkbox" id="feeRateBase" v-model.number="productData.feeRateBase" @click="calculFeeRateFn({type: '1'})" />&emsp;
                      <label for="feeRateBase"> 기본 <b>[9%]</b></label>
                      <br />
                      <input type="checkbox" id="feeRateMedia" v-model.number="productData.feeRateMedia" @click="calculFeeRateFn({type: '1'})"/>&emsp;
                      <label for="feeRateMedia"> 영상제작 <b>[9%]</b></label>
                      <br />
                      <input type="checkbox" id="feeRateInfluencer" v-model.number="productData.feeRateInfluencer" @click="calculFeeRateFn({type: '1'})"/>&emsp;
                      <label for="feeRateInfluencer">인플루언서 <b>[9%]</b></label>
                    </div>
                  </template>
                  <template v-if="productData.feeTypeCode === 2">
                    <div style="width: 200px">
                      ...
                      <label for="priceTypeCode1"> 공급가기준 <span>(수수료 자동입력)</span></label>
                      <br />
                      ...
                      <label for="priceTypeCode2">수수료기준<span>(공급가 자동입력)</span></label>
                    </div>
                  </template>
            ...
            <tr>
              ...
              <td>
                <dl class="delivery_method">
                  <dt>
                    <input type="radio" id="deliveryPriceTypeCode1" name="deliveryPriceTypeCode" v-model.number="productData.deliveryPriceTypeCode" value="1" />
                    <label for="deliveryPriceTypeCode1">무료배송</label>
                  </dt>
                  <dd>해당상품을 무료배송합니다.</dd>

                  <dt>
                    <input type="radio" id="deliveryPriceTypeCode2" name="deliveryPriceTypeCode" v-model.number="productData.deliveryPriceTypeCode" value="2"/>
          ...
          <tbody>
            <tr>
              ...
              <td class="option_kind">
                <ul>
                  <li>
                    <input type="radio" id="option_kind_1" name="optionTypeCode" value="1" v-model.number="productData.optionTypeCode" />
                    <label for="option_kind_1">옵션없음</label>
                  </li>
                  <li>
                    <input type="radio" id="option_kind_2" name="optionTypeCode" value="2" v-model.number="productData.optionTypeCode"/>
                    <label for="option_kind_2">일반옵션</label>
                  </li>
                  <li>
                    <input type="radio" id="option_kind_3" name="optionTypeCode" value="5" v-model.number="productData.optionTypeCode"/>
          ...
          <tbody>
            <tr>
              ...
              <td class="addition_usable">
                <ul>
                  <li>
                    <input type="radio" id="use_addition_0" name="isAddingProduct" v-model.number="productData.isAddingProduct" value="0"/>
                    <label for="use_addition_0">미사용</label>
                  </li>
                  <li>
                    <input type="radio" id="use_addition_1" name="isAddingProduct" v-model.number="productData.isAddingProduct" value="1"/>
      ...
      <div class="btn_center">
        <b-button type="submit" variant="secondary" style="margin-right: 5px">
...
import FileUploader from '@/components/goodsReg/FileUploader'
