                ...
                <form name="Frm">
                    <table class="t_form">
                        ...
                        <tbody>
                                    ...
                                    <ul class="arrange method">
                                        <li>
                                            <div class="form-check">
                                              <input class="form-check-input" type="radio" name="method" id="method_1" value="101" v-model.number="couponData.couponType"/>
                                              <label class="form-check-label" for="method_1">상품 발급</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                              <input class="form-check-input" type="radio" name="method" id="method_2" value="102" v-model.number="couponData.couponType"/>
                                        ...
                                        <li>
                                            <div class="form-check">
                                              <input class="form-check-input" type="radio" name="method" id="method_4" value="104" v-model.number="couponData.couponType"/>
                            ...
                            <!-- 쿠폰방식101 :  상품발급 -->
                        <template v-if="couponData.couponType === 101">
                                    ...
                                    <div class="over_h">
                                        <div class="fl" style="width:130px">
                                            <label for="use_limit_day_t">
                                                <input type="radio" id="use_limit_day_t" name="isUseLimitDay" value="T" onclick="checkUseLimit()" checked>
                                            사용일자 설정 :</label>
                                        </div>
                                        <div class="fl">
                                            <ul class="arrange">
                                    ...
                                    <div class="over_h mgt10">
                                        <div class="fl" style="width:130px">
                                            <label for="use_limit_day_f">
                                                <input type="radio" id="use_limit_day_f" name="isUseLimitDay" value="F" onclick="checkUseLimit()">사용기간 설정 :</label>
                                        </div>
                                        <div class="fl">                                            
                                             <!-- 달력 -->
                                            <sws-date></sws-date>                                 
                                    ...
                                    <ul class="arrange">
                                        <li>
                                            <label for="member_level_0">
                                                <input type="checkbox" id="member_level_0" onclick="checkCbAll(this.form.memberLevel, this.checked)"><strong>전체 등급</strong>
                                            </label>
                                        </li>
                                    </ul>
                                </td>
                        ...
                        <!-- 쿠폰방식102 : 구매보상발급 -->
                        <template v-if="couponData.couponType === 102">
                            <tr class="method_goods">
                                <th><span class="red">*</span> 진행기간</th>
                                <td colspan="3">
                                    <!-- 달력 -->
                        ...
                        <!-- 쿠폰방식104 : 회원가입발급 -->
                        <template v-if="couponData.couponType === 104">                          
                            <tr>
                                <th><span class="red">*</span> 사용기간</th>
                                <td colspan="3">
                                    <div class="over_h">
