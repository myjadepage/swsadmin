<template>
     <div id="contents">
                ...
                <form name="sFrm" method="get" action="/statistics/goods_marks">
                    ...
                    </select>&nbsp;<input type="text" name="sword" value="" class="text_input" style="width:300px">
                                        </div>
                                    </div>
                    ...
                    <div class="section_head">
                        ...
                        <div><span class="button black"><a href="/statistics/goods_marks.excel?sdate=2020-01-01edate=2020-01-28&skey=&sword=">엑셀로받기</a></span></div>
                    </div>
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%" class="t_list">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td height="50" colspan="3">고객평점 통계가 없습니다.</td>
                        </tr>
